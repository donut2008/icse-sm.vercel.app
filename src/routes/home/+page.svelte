...
<div class="text-center object-center">
    <Heading tag="h1" class="mt-16 mb-16" customSize="text-4xl font-extrabold md:text-5xl lg:text-6xl text-black dark:text-white">Welcome to ICSE Study Material!</Heading>
    <P class="mb-6 text-lg lg:text-xl sm:px-16 xl:px-48 text-gray-100 dark:text-gray-400">This site is still under construction. Feel free to look around to see what's done (if anything is, so far)!</P>
</div>